...
struct CompositionOverlayTextOp {
  let text: String
  let x: CGFloat
  let y: CGFloat
  let scale: CGFloat
...
enum CompositionOverlayRenderer {
  static func apply(overlays: [CompositionOverlayTextOp],
                    to image: CIImage,
                    renderSize: CGSize,
                    time: CMTime) -> CIImage {
  ...
  private static func makeTextImage(for overlay: CompositionOverlayTextOp, canvasSize: CGSize) -> CGImage? {
